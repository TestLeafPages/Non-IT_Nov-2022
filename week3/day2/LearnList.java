...
public class LearnList {
	...
	public static void main(String[] args) {
		...
		// listname.get(index);-->to get the element from the particular index
		  ...
		  Integer integer = num.get(1); System.out.println(integer);
		  
		  //length of the list 
		  int size = num.size(); System.out.println(size);
		  ...
		  Collections.sort(num); System.out.println(num);
		  
		  Collections.reverse(num); System.out.println(num);
		  ...
		  num.clear(); System.out.println(num);
